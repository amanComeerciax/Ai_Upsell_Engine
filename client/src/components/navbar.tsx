        ...
        >
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <div className="h-10 w-10 rounded-xl overflow-hidden shadow-lg shadow-cyan-500/20 group-hover:scale-110 transition-transform duration-300">
              <img src="/logo.png" alt="Upsell.ai Logo" className="h-full w-full object-cover" />
            </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="h-10 w-10 rounded-xl flex items-center justify-center text-slate-500 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
            >
            ...
            <div className="hidden sm:flex items-center gap-3">
              <SignedOut>
                <Link to="/login">
                  <Button variant="ghost" className="text-sm font-semibold rounded-xl">
                    Log In
                  </Button>
                </Link>
                <Link to="/signup">
                  <Button className="bg-slate-900 dark:bg-white text-white dark:text-black hover:bg-slate-800 dark:hover:bg-slate-100 rounded-xl shadow-lg shadow-black/10 transition-all active:scale-95 group">
                    Start Free
            ...
            <button
              ...
              className="md:hidden h-10 w-10 rounded-xl flex items-center justify-center bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-300 transition-transform active:scale-90"
            >
            ...
            <>
              ...
              >
                ...
                <div className="mt-auto pt-8 border-t border-slate-100 dark:border-white/10 flex flex-col gap-4">
                  <SignedOut>
                    <Link to="/login" onPointerDown={() => setMobileOpen(false)}>
                      <Button variant="outline" className="w-full h-12 rounded-xl">
                        Log In
                      </Button>
                    </Link>
                    <Link to="/signup" onPointerDown={() => setMobileOpen(false)}>
                      <Button className="w-full h-12 rounded-xl bg-cyan-500 hover:bg-cyan-600 text-white">
                        Get Started
                      </Button>
                    </Link>
                  </SignedOut>
                  <SignedIn>
                    <Link to="/dashboard" onPointerDown={() => setMobileOpen(false)}>

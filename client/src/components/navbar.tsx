    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/70 backdrop-blur-md">
      <nav className="mx-auto flex max-w-[1400px] items-center justify-between px-6 py-5">
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <SignedIn>
            <Link to="/dashboard">
              <Button variant="ghost" className="text-[15px] font-semibold text-foreground px-5 hover:bg-transparent flex items-center gap-2">
                Console <ArrowRight className="h-4 w-4" />
              </Button>
            </Link>
            <UserButton appearance={{ elements: { userButtonAvatarBox: 'h-9 w-9 rounded-xl' } }} />
          </SignedIn>
        </div>
            ...
            <div className="flex flex-col gap-4 pt-8 border-t border-border/10">
              ...
              <SignedIn>
                ...
                <div className="flex items-center gap-4 py-2">
                  ...
                  <span className="text-sm font-bold text-muted-foreground uppercase tracking-widest">Active Profile</span>
                </div>
              </SignedIn>

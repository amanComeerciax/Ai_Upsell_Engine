        ...
        <div className="p-8 space-y-8 max-w-[1600px] mx-auto">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500 mt-1 font-medium">Manage all registered stores and subscriptions.</p>
                </div>
                <Badge variant="outline" className="px-3 py-1 font-bold text-indigo-600 bg-indigo-50 border-indigo-200">
            ...
            <div className="flex gap-4">
                <div className="relative flex-1 group">
                    ...
                    <Input 
                        ...
                        className="pl-10 h-11 bg-white border-gray-200 focus:border-indigo-500 rounded-xl"
                        value={searchTerm}
                        onChange={(e) => setSearchTerm(e.target.value)}
                    />
                </div>
                <Button variant="outline" className="h-11 rounded-xl font-bold border-gray-200">
                ...
                <Table>
                    <TableHeader className="bg-gray-50/50">
                        <TableRow className="hover:bg-transparent">
                            ...
                            <TableHead className="font-bold text-gray-700">Shopify Store</TableHead>
                    ...
                    <TableBody>
                        {filteredMerchants.map((merchant) => (
                            <TableRow key={merchant.id} className="group hover:bg-gray-50/50 transition-colors">
                                <TableCell>
                                    <div className="font-extrabold text-gray-900">{merchant.business_name || 'Unnamed Merchant'}</div>
                                    <div className="text-xs text-gray-400 font-medium">{merchant.email}</div>
                                </TableCell>
                                <TableCell>
                                    <div className="flex items-center gap-1.5 font-bold text-indigo-600 hover:underline cursor-pointer">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Badge 
                                            className={merchant.plan === 'pro' 
                                                ...
                                                : "bg-gray-50 text-gray-600 border-gray-100 font-bold"
                                            }
                                        >
